    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex">
          ...
          {/* Tab selector — for faculty, show ONLY Committee tab (no Students tab) */}
{role === 'faculty' && (
  <div className="flex border-b border-gray-200 bg-white">
    <div className="flex-1 py-2 text-xs font-medium text-center text-violet-700 border-b-2 border-violet-500 bg-violet-50">
    </div>
  </div>
)}
