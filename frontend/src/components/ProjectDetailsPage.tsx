// frontend/src/components/ProjectDetailsPage.tsx
  ...
  if (error && (error.includes('group') || error.includes('finalized') || !data)) {
    return (
      <div className="p-8 max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl text-gray-900 mb-2">Project Details</h1>
          <p className="text-gray-600">View detailed information about past graduation projects</p>
        </div>
          ...
          <CardContent className="py-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                Project details will be available once your group is finalized.
      ...
      <div className="p-8 max-w-4xl mx-auto">
        ...
        <Card className="border-amber-200 bg-amber-50">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              No projects match your group's profile. Make sure your group is finalized and try again.
            </p>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="p-8 max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Key details of the {data.projects.length} recommended projects
        </p>
      </div>
                  ...
                  <div>
                    ...
                    {shouldTruncateFutureWork && (
                      <Button
                        ...
                        className="text-xs text-indigo-600 hover:text-indigo-700 p-0 h-auto mt-1"
                      >
                        {isFutureWorkExpanded ? 'Show less' : 'Read more...'}
                      </Button>
                    )}
                  </div>
                )}
